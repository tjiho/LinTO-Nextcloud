// Ported from linto-studio/studio-api components/EditorHandler/utils/interpolate.js
// (CommonJS -> ESM only, logic untouched).

import { countSyllabsFromWord } from "./countSyllabsFromWord"
 ...
 */
export function interpolateWordTimes(words, turn, syllabic) {
  let i = 0
