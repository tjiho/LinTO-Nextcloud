// Ported from linto-studio/studio-api components/EditorHandler/utils/computeSplitTurns.js
...
/** Word from a layout entry — undefined fields OMITTED, never written. */
function makeWord(text, src) {
  const word = { wid: src.wid ?? generateId(), word: text }
...
/**
 * Split a turn at a character offset of its derived single-space text.
 ...
 */
export function computeSplitTurns(turn, offset) {
