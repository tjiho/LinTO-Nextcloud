// Ported from linto-studio/studio-api components/EditorHandler/utils/retimeTurn.js
// (CommonJS -> ESM only, logic untouched).

import { interpolateWordTimes } from "./interpolate"
 ...
 */
export function retimeTurn(tokens, carried, turnBounds, syllabic) {
